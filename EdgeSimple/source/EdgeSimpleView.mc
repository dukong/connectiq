...
class EdgeSimpleView extends Ui.DataField {
    ...
    function initialize() {
    	...
    	lb_descent = Ui.loadResource(Rez.Strings.str_descent);
    ...
    function compute(info) {
    	...
    	if (info has :totalDescent && info.totalDescent != null) {
    		descent = info.totalDescent.format("%d");
    	}
	...
	function drawData(dc) {		
		...
		dc.drawText(51, 95, Graphics.FONT_NUMBER_MEDIUM, alt, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
		dc.drawText(151, 95, Graphics.FONT_NUMBER_MEDIUM, dst, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
		
		dc.drawText(100, 153, Graphics.FONT_NUMBER_HOT, spd, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
		
		dc.drawText(51, 212, Graphics.FONT_NUMBER_MEDIUM, descent, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
    ...
    function drawLabel(dc) {    	
    	...
    	dc.drawText(1, 61, Graphics.FONT_XTINY, lb_alt, Graphics.TEXT_JUSTIFY_LEFT);
    	dc.drawText(199, 61, Graphics.FONT_XTINY, lb_dst, Graphics.TEXT_JUSTIFY_RIGHT);
    	
    	dc.drawText(1, 120, Graphics.FONT_XTINY, lb_spd, Graphics.TEXT_JUSTIFY_LEFT);
    	dc.drawText(199, 120, Graphics.FONT_XTINY, lb_spd, Graphics.TEXT_JUSTIFY_RIGHT);
    	
    	dc.drawText(1, 179, Graphics.FONT_XTINY, lb_descent, Graphics.TEXT_JUSTIFY_LEFT);
